        ...
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container">
                  ...
                  <!--      <ul class="nav pull-right">
                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">More Menu
                                <b class="caret"></b></a>
                                <ul class="dropdown-menu">
                                    <li><a href="#"> Our Mission</a></li>
                                    <li><a href="#">Our Vision</a></li>
                                    <li class="divider"></li>
                                    <li class="nav-header">About Dantech</li>
                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="photosnap.php"><i class="menu-icon icon-group"></i>Visitors <b class="label orange pull-right">
                                    <?php echo $total_visitors; ?></b> </a></li>
                            </ul>
                            <!--/.widget-nav-->
                            
                            
                            <ul class="widget widget-menu unstyled">
                                <li><a href="users.php"><i class="menu-icon icon-user"></i> Users  <b class="label orange pull-right">
                            ...
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li>
									...
									<a href="index.php" ><i class="menu-icon icon-signout"></i>Logout </a>
								</li>
                            </ul>
                        </div>
                        <!--/.sidebar-->
